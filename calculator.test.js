...
test("-10 / (20 / 4 * 5 / 5) * 8 - 2  = -18", () => {
  expect(calculate("-10 / (20 / 4 * 5 / 5) * 8 - 2")).toBe(-18);
});

test("-2 * (1 * 4 - 2 / 2) + (6 + 2 - 3) = -1", () => {
  expect(calculate("-2 * (1 * 4 - 2 / 2) + (6 + 2 - 3)")).toBe(-1);
});

test("2 * 11 + 13 - -23 / 2 + 6.555 * 10 - 21 / 2 * 1.165 + 61 - 100 * .123 / 10 * 7 - 1 + 15 / 10 - .65 + -1.5 * 3 + 13 = 160.5575", () => {
  expect(
    calculate(
      "2 * 11 + 13 - -23 / 2 + 6.555 * 10 - 21 / 2 * 1.165 + 61 - 100 * .123 / 10 * 7 - 1 + 15 / 10 - .65 + -1.5 * 3 + 13"
    )
  ).toBe(160.557499);
});

test("2 * (11 + 13) - (-23 / 2 + 6.555) * 10 - 21 / (2 * 1.165) + 61 - 100 * (.123 / 10 * 7 - 1 + 15) / 10 - (.65 + -1.5) * 3 + 13 = 24.1261244635", () => {
  expect(
    calculate(
      "2 * (11 + 13) - (-23 / 2 + 6.555) * 10 - 21 / (2 * 1.165) + 61 - 100 * (.123 / 10 * 7 - 1 + 15) / 10 - (.65 + -1.5) * 3 + 13"
    )
  ).toBe(24.126124463519318);
});

test("-(2 * -(11 + 13) - (-24 / -2) * 10 - -22 / -2 + 61 - 100 * (5 / 10) * -5 ) = -132", () => {
  expect(calculate("-(2 * -(11 + 13) - (-24 / -2) * 10 - -22 / -2 + 61 - 100 * (5 / 10) * -5 )")).toBe(-132);
});
